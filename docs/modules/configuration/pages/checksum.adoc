...
checksum:
  ...
  # Valid values are [`MD2`, `MD5`, `RMD160`, `SHA_1`, `SHA_256`, `SHA_384`, `SHA_512`, `SHA3_224`, `SHA3_256`, `SHA3_384`, `SHA3_512`].
  # Default value is `SHA-256`.
  # `SHA_256` is always configured.
  # icon:dot-circle[]
  algorithms:
    - MD5
    - SHA_256
